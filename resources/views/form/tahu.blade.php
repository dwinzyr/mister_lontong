...
<head>
    ...
    <style>
        body {
            background-color: #f0f3f5; /* Warna latar yang lembut */
            font-family: 'Poppins', sans-serif; /* Font yang modern */
        }
        .card {
            margin-top: 50px;
            border: none;
            border-radius: 15px;
            box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); /* Efek bayangan lembut */
        }
        .card-header {
            background: linear-gradient(135deg, #6AC1B8 0%, #96CEB4); /* Gradien untuk tampilan premium */
        ...
        .btn-primary {
            background-color: #96CEB4; /* Warna tombol sesuai dengan header */
            border: none;
            border-radius: 10px;
            padding: 12px 20px;
            font-size: 16px;
